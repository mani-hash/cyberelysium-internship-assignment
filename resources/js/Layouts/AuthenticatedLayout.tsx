...
function AuthenticatedNavBar({ user }: { user: User }) {
    const [showingNavigationDropdown, setShowingNavigationDropdown] = useState<boolean>(false);

    // Svg for drop down icon
    const drop_down_svg: ReactNode = (
        <svg
    ...
    // Svg for hamburgher icon
    const hamburgher_svg: ReactNode = (
    ...
    return (
        <nav className="bg-white border-b border-gray-100 sticky top-0 shadow-md">
            {/* Normal navbar */}
